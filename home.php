...
<nav class="nav-extended blue-grey darken-4">
    ...
    <div class="nav-content">
        <ul class="tabs tabs-transparent tabs-fixed-width">
            ...
            <li class="tab"><a href="#tablecontent">User data</a></li>
...
<div id="runData" class="col s12 container tabWrapper" class="row">
    <form action="run.php" name="run" method="post" class="col s12 grey-text">
        ...
        <div class="row">
            ...
            <div class="input-field col s2">
                <input id="timeStartID" type="text" name="start" class="timepicker">
                <label for="timeStartID">Start</label>
            </div>
            <div class="input-field col s2">
                <input id="timeEndID" type="text" name="end" class="timepicker">
...
<div id="tablecontent" class="col s12 container tabWrapper grey-text" style="overflow: auto">
<?php
require 'config.php';
// DB connect
